...
const BusinessSummary = () => {
  ...
  return (
    <div className="page">
      ...
      <div className="card">
        <p>Business Money: ₹24,500</p>
        <p>Money In (This Month): ₹{totalIncome.toLocaleString()}</p>
        <p>Money Out (This Month): ₹{totalExpense.toLocaleString()}</p>
        <p>Pending Payments: ₹{pendingPayments.toLocaleString()}</p>
      </div>
        ...
        <div className="table">
          ...
          {monthlyTransactions.map((t, idx) => (
            <div key={`${t.type}-${idx}`} className="table-row">
              ...
              <div className={`amount ${t.type}`}>₹{t.amount.toLocaleString()}</div>
